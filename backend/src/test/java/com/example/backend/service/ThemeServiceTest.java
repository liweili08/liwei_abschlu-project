...
class ThemeServiceTest {
    ...
    void getAllTheme() {
        ...
        List<MathBasic> basicListTest= new ArrayList<MathBasic>();
        basicListTest.add(basic1);
        basicListTest.add(basic2);

        List<MathExample> exampleListTest=new ArrayList<MathExample>();
        exampleListTest.add(example1);
        exampleListTest.add(example2);

        List<MathHomework> homeworkListTest=new ArrayList<MathHomework>();
        ...
        List<MathTheme> mathThemeListTest =new ArrayList<MathTheme>();
